...
from livros.views import LivrosCreateView,LivrosListView,LivrosDeleteView,LivrosUpdateView, LivrosLancamento


urlpatterns = [
    path('admin/', admin.site.urls),
    path('', LivrosListView.as_view(),name='livros_list'),
